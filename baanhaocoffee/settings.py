"""
Django settings for baanhaocoffee project.
...
SECRET_KEY = 'django-insecure-hjmu4q-!%q5vo@ip3rq57lpx8oq=i8+y_lstjsmj4-!)8)wl7a'
...
ROOT_URLCONF = 'baanhaocoffee.urls'
...
WSGI_APPLICATION = 'baanhaocoffee.wsgi.application'
